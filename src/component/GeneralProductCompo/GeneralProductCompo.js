...
export const GeneralProductCompo = ({ productInfo, productImageList }) => {
  let IP;
          ...
          <TwoGridAllWrapper className="TwoGridAllWrapper">
            <div className="colBox" style={{ width: "90%" }}>
              ...
              <div className="productMainImageArea">
                <img
                  ...
                  src={productImageList[0].Image_file}
                />
              </div>
            ...
            <div className="colBox" style={{ gap: "10px" }}>
              ...
              <div className="colBox">
                ...
                {productInfo.show_status === "N" && <div>일시품절</div>}
              </div>
              <SelectPaire>
                <div className="colBox">
                  <div className="inputLabel sameLabel">
                    상품가격: {productInfo.product_price}
                  </div>
                </div>
              </SelectPaire>
              <div className="colBox">
                <div
                  ...
                  onClick={() => {
                    ...
                    axios
                      .post(`http://${IP}:4000/user/firstAddCart`, productInfo)
                      .then((res) => {
                        console.log(res);

                        let { addCartStatus } = res.data;
