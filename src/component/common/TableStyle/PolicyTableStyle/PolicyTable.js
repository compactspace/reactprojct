...
const PolicyTableStyle = styled.div`
  display: flex;
        ...
        {keysToExtract.map((v, colIdx) => (
          <div
            ...
            onClick={(e) => {
              ...
              v.includes("cellAction") && cellClickFnc.clopenModal(rowIdx);
            }}
          >
  ...
  return (
    <>
      {rowCount === 0 ? (
        ...
        <>
          {InputType != "" && (
            <PolicyTableStyle tBodyRow={tBodyRow}>
