...
export const PhoneOneDayClassBody = (props) => {
  ...
  let [cookiestatuscode, setCookiestatuscode] = useState(null);
  ...
  useEffect(() => {
    ...
    for (let k = 0; k < test.length; k++) {
      test[k].addEventListener("click", (e) => {
        ...
        axios
          .get(
            URL +
              "/noneuser/checkoutrest?onedayclass_num=" +
    ...
    axios
      .get(
        URL +
          "/user/reivew?limit=0 &onedayclass_num=" +
          `${props.onedayclass_num}`
      )
      .then((res) => {
      ...
      <AllWrapper className="AllWrapper">
        <ContentWrapper>
          ...
          <div className="titlearea" data-value={props.openclass_id}>
            ...
            <div className="titleinfo">원데이</div>
            ...
            <div
              ...
              onClick={() => {
                ...
                if (cookiestatuscode != 1) {
                  ...
                  alert(
                    "문의 요청 하셨습니다\n 선생님이 수락후 채팅방으로 이동합니다."
                  );
                  chatsocket.on("confirm", (data) => {
                    // alert(data);
                    if (data.resstatus == 1) {
                      // alert("채팅방으로이동합니다.")
                      // alert('/phoneqna/' + onedayclass_num + "/" + userid);
                      naviegate("/phoneqna/" + onedayclass_num + "/" + userid);
                    } else {
          ...
          <Reivewwrapper className="reivewwrapper">
            <div className="reivewarea">
              ...
              <h3
                onClick={() => {
                  naviegate("/writingreview/" + props.classid);
                }}
              >
                후기 작성하기
              </h3>
