...
const MessageAuthoarea = styled.div`
  ...
  z-index: 1000; /* 모달이 다른 요소들 위에 오도록 설정 */
  ...
  & .modal {
    ...
    top: 50%; /* 화면에서 수직 중앙 */
    left: 50%; /* 화면에서 수평 중앙 */
    transform: translate(-50%, -50%); /* 정확히 중앙에 위치시키기 위해 이동 */
    background: white;
    padding: 20px;
    border-radius: 8px;
    width: 600px; /* 원하는 너비 */
  ...
  .modal_body {
    ...
    box-shadow: 0 2px 3px 0 rgba(34, 36, 38, 151.15); //테두리 그림자
  }
...
export const UpdateClassInfoModalStyle = ({
  수업정보상태,
  set수업정보상태,
  기본클래스정보모달열기,
  set기본클래스정보모달열기,
  ...
  return (
    <>
      <MessageAuthoarea className="modalbackground">
