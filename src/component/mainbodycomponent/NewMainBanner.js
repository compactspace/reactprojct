...
export const NewMainBanner = (props) => {
  ...
  useEffect(() => {
    ...
    const rollringinfobanner =
      document.getElementsByClassName("rollringinfobanner")[0];
    window.addEventListener("scroll", () => {
      ...
      for (let k = 0; k < rolling.length; k++) {
        if (scrollTop < 487) {
          rolling[0].style.cssText =
            "display:block; transform:translateY(-" + scrollTop + "px)";
          ...
          rolling[1].style.cssText =
            "display:block; transform:translateY(-" +
            (scrollTop - rollingheight) +
            "px)";
        } else if (800 < scrollTop && scrollTop < 1500) {
          rolling[1].style.cssText = "display:none";
          rolling[2].style.cssText =
            "display:block; transform:translateY(-" +
            (scrollTop - 2 * rollingheight) +
            "px)";
        }
      ...
      <Swiperallwrapper className="swiperallwrapper">
        <div id="swipercontainerwrapper" class="swipercontainerwrapper">
          <div class="swiper_container">
            ...
            <video className="videobanner" muted autoPlay loop>
              {/* 
                                ...
                                */}
              <source
                src="https://videos.pexels.com/video-files/9968970/9968970-uhd_2560_1440_25fps.mp4"
                type="video/mp4"
              />
          ...
          <div class="rollringinfobanner">
            <div class="rolling">
              <p>매주마다 뭐할까 고민인가요??</p>
              <p>이제 고민 마세요 뭐할까? 에서 취미생활을 찾아보세요</p>
            </div>
            <div class="rolling">
              <p>혹은 나의 재능을</p>
              <p>펼칠 경험해보고 싶은가요?</p>
