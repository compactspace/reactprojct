...
height:${(props) => {
        ...
        else if (props.finallcheck && props.bodyheight != null) {
            return;
        }
...
`
const Row2ModalRow2 = styled.div`
...
export const Reserve = () => {
    ...
    const ShowCalendar = async (e) => {
        ...
        // react-calendar__month-view__days
        // console.log(e)
        if (reserveinfo.classname == "") {
            
       alert("클래스강좌를 먼저 선택해주세요")  
            ...
            for (let k = 0; k < sibal.length; k++) {
             ...
             console.log("날짜를배열로담기"+forcompare);
    ...
    useEffect(() => {
        ...
        //finall스텝시 조건문이 먼저 타게되면서 유즈이펙트가 활성화 되는데 이시점에선 calendar 태그가 읽히지 않나 널오류로
        //calendar.current!=null 조건을 먼저추가함...
        if (calendar.current != null) {
    ...
    const Reservationinfo = async () => {
        ...
        if (key == null) { alert("로그인을 먼저 해주세요") } else {
            ...
            await axios.post('http://localhost:4000/user/reservationinfo', null, {
                ...
                console.log("렝스는->>" + reserveinfo.length)
    ...
    const Finallinfocheck = () => {
        if (reserveinfo.choiceDay == "") { alert("예약정보를 먼저 입력해 주세요") }
        else {
    ...
    return (
        <>
            ...
            {check == null ? <><Navforproduct navheightset={navheightset}></Navforproduct></>
                : <>
                    <Navforproduct iscookie={true} navheightset={navheightset} ></Navforproduct></>}
            <Bodywrapper classname='Bodywrapper' finallcheck={finallcheck} bodyheight={bodyheight} match={match} calendarheight={calendarheight}>
                {finallcheck ? <>
                    <Row1 classname='row1'>
                        <Row1Col1>FinallStep</Row1Col1>
                        <Row1Col2 classname='Row1Col2' match={match}>
                            예약 확정</Row1Col2>

                    </Row1>
                    <Row2ModalRow2 classname='row2'>
                                ...
                                <Row2Col1Row1 classname='Row2Col1Row1' match={match}>
                                    ...
                                    <Row2Col1Row1SubWrow2 classname='Row2Col1Row1SubWrow2'>
                                        ...
                                        {reserveinfo.classname ?
                                            <>
                                                <H2row3 ><span className="step">Step2</span><span className='stepname'>클래스강좌선택{`(필수)`}</span></H2row3>
                                                <H2row3 ><span className="stepclick" style={{ borderBottom: "1px solid #dadbdc" }}>{reserveinfo.classname}을선택하셨습니다. </span></H2row3>
                                                <H2row3 onClick={ChoiceClass} ><span className='stepclick'>변경하기</span></H2row3>
                                            </>
                                            :
                                            <>    <H2row3 ><span className="step">Step2</span><span className='stepname'>클래스강좌선택{`(필수)`}</span></H2row3><H2row3 onClick={ChoiceClass} ><span className='stepclick'>Click</span></H2row3></>}
                                    ...
                                    <Row2Col1Row1SubWrow3 ref={scrolltop} classname='Row2Col1Row1SubWrow3'>
                                        <H2row3 ><span className="step">Step4</span><span className='stepname'>예약일정{`(필수)`}</span></H2row3>
                                        {choiceDay ? <><H2row3 ><span className="stepclick" style={{ borderBottom: "1px solid #dadbdc" }}> {choiceDay + ` 을 선택하셨습니다.`} </span></H2row3>
                                    ...
                                    <Row2Col1Row1SubWrow4 className="Row2Col1Row1SubWrow4" dropreserveinfo={dropreserveinfo}>
                                        <H2row3><span className='step'>Step5</span><span className="stepname">예약정보입력{`(필수)`}</span></H2row3>
                                        {reserveinfo.name ? <><h3 className="logininfo"><span>입력되셨습니다.</span></h3><Bottonrow3 onClick={Dropmenu}>예약자정보수정</Bottonrow3></> :
                                            dropreserveinfo ?
                                                <><h3 className="logininfo" onClick={Reservationinfo}><span>로그인정보로</span></h3> <h3 className="logininfo"><span>직접입력</span></h3></>
                                    ...
                                    <Row2Col1Row1SubWrow5 >
                                        ...
                                        <H2row4 onClick={Finallinfocheck}><span className="confirm">확정하기</span></H2row4>
                                    </Row2Col1Row1SubWrow5>
                                </Row2Col1Row1>
