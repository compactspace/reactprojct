...
export const OneDayClasspage = () => {
  ...
  useEffect(() => {
    axios
      .post(
        `http://${IP}:4000/noneuser/OneDayClasspage`,
        JSON.stringify(data),
        {
          headers: {
  ...
  const [onedayimg, setOnedayimg] = useState([
    oneday11,
    oneday12,
    oneday13,
    oneday14,
  ...
  const [onedayimg2, setOnedayimg2] = useState([
    oneday21,
    oneday22,
    oneday23,
    oneday24,
  ...
  const [onedayimg3, setonedayimg3] = useState([
    oneday31,
    oneday32,
    oneday33,
    oneday34,
  ...
  const [onedayimg4, setonedayimg4] = useState([
    oneday41,
    oneday42,
    oneday43,
    oneday44,
  ...
  const [onedayimg5, setonedayimg5] = useState([
    oneday51,
    oneday52,
    oneday53,
    oneday54,
